      ...
      action: {
        ...
        root: {
          ...
          handler: function(req, res) {
            ...
            if (!req.body.username || !username_regex.test(req.body.username)) {
              throw new ModelError('nousername',
                'A username must be supplied to register a new user.', [],
                400);
            }

            if (!req.body.password || req.body.password === '') {
              throw new ModelError('nopassword',
            ...
            if (password_result.score < 3) {
              throw new ModelError('insecurepassword',
        ...
        'merge': {
          ...
          function(req, res){
            ...
            return User.findById(req.body.fromToken._id).exec()
              .then(function(user) {
                if (!user) {
